...
//diferença principal entre expressão de função e declaração de função: HAISTING (puxar pra cima)
//o js faz o haisting com a declaração de função, que é quando ele vai ler o código, primeiro ele lista todas as funções de declaração, e as vars, e só dps as outras coisas.
